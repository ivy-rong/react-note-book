...
declare global {
  ...
  const BaseFooter: typeof import('./src/components/index')['BaseFooter']
  ...
  const ListItem: typeof import('./src/components/index')['ListItem']
  const NavLink: typeof import('react-router-dom')['NavLink']
  const Navigate: typeof import('react-router-dom')['Navigate']
  const NoteListCard: typeof import('./src/components/index')['NoteListCard']
